...
CREATE TABLE `Issue_Evidences` (
  ...
  CONSTRAINT `Issue_Evidences_ibfk_3` FOREIGN KEY (`IndustryIssueId`) REFERENCES `Industry_Issues` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `Issue_Evidences_ibfk_4` FOREIGN KEY (`EvidenceId`) REFERENCES `Evidence` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dump completed on 2023-06-29 15:25:01
